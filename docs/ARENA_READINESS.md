...
> 本页是 2026-09-13 正式比赛开始前的准备快照，保留用于审计，不再代表赛后最终状态。正式 Arena 运行、消息 sequence、credits 收入和证据缺口见 [`LIVE_RUN_2026-09-13.md`](LIVE_RUN_2026-09-13.md)。官方账本确认本项目累计获得 `received=36` credits 收入。
