...
本手册供团队接入销售 Agent、核对宣传承诺和准备比赛提交使用。基于当前 main 9dff6be664f216769621a6ff6e72e3372581cc3a，两项服务均为6 credits、底价5，报告保持14项风险标记。Discord 两项信息已确认，其余身份和线上信息按用户要求暂缓；所有官方字段仅由 submission.json 管理。当前不声称完成正式提交。
