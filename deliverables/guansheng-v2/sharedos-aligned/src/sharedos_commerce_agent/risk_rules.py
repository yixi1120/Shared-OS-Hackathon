"""Frozen buyer-facing meanings; flags are diagnostics, never extra penalties."""
...
def interpret_risks(flags: list[str]) -> list[dict[str, str]]:
    return [
        {"flag": flag, "zh": RISK_MEANINGS[flag][0], "en": RISK_MEANINGS[flag][1]}
        for flag in flags
    ]
